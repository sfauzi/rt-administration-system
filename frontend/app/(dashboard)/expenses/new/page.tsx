    ...
    <div className="min-h-screen bg-slate-50 p-8">
      <div className="max-w-2xl space-y-6">
        ...
        <div>
          ...
          <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Add Expense</h1>
          <p className="text-sm text-gray-400 mt-0.5">Record a new expense entry</p>
        </div>
        ...
        >
          ...
          <div className="p-6 space-y-5">
            ...
            {/* Recurring toggle */}
            <div className={`flex items-start gap-3 rounded-xl border px-4 py-3.5 cursor-pointer
              transition-colors ${form.is_recurring
